...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const footerHTML = `<footer class="flex justify-between py-3 px-8 md:px-12 text-sm bg-[var(--primary-contrast)] text-[var(--bg-color)] border-t-2 border-[var(--subtitle-color)]">
